...
class Cube :public Basic_Primitive
{
public:
	Cube(M3DVector3f left_up, M3DVector3f right_up, M3DVector3f right_down, M3DVector3f left_down, M3DVector3f color)
		:Basic_Primitive(_k_cube)
...
public:
	...
	virtual	bool	get_refract_direct(const M3DVector3f direct, const M3DVector3f intersect_p, M3DVector3f refract_direct, float delta, bool is_in);
