...
//Cube
	M3DVector3f	c_x0y0z0 = { _dim[0] * 0.55, _dim[1] * 0.6, _dim[2] * 0.1 };
	M3DVector3f	c_x1y0z0 = { _dim[0] * 0.75, _dim[1] * 0.6, _dim[2] * 0.1 };
	M3DVector3f	c_x0y1z0 = { _dim[0] * 0.55, _dim[1] * 0.8, _dim[2] * 0.1 };
	M3DVector3f	c_x1y1z0 = { _dim[0] * 0.75, _dim[1] * 0.8, _dim[2] * 0.1 };

	M3DVector3f	c_x0y0z1 = { _dim[0] * 0.57, _dim[1] * 0.62, _dim[2] * 0.3 };
	M3DVector3f	c_x1y0z1 = { _dim[0] * 0.77, _dim[1] * 0.62, _dim[2] * 0.3 };
	M3DVector3f	c_x0y1z1 = { _dim[0] * 0.57, _dim[1] * 0.82, _dim[2] * 0.3 };
	M3DVector3f	c_x1y1z1 = { _dim[0] * 0.77, _dim[1] * 0.82, _dim[2] * 0.3 };
...
//Spheres
	...
	M3DVector3f sphere_color2 = {0.913725, 0.588235, 0.478431 };
